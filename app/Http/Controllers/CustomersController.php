...
//					}
	...
	public function updatePipedriveDeal($deal_id, $sales_price, $status = 'won'){
		try {
			$deal = Pipedrive::executeCommand( config( 'pipedrive.api_key' ), new Pipedrive\Commands\UpdateDeal( $deal_id, $sales_price, $status ) );
			if (
				!empty($deal) &&
				!empty($deal->data) &&
				!empty($deal->data->id)
