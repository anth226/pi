  ...
  <div align="center">
      ...
      <tr class="header-background">
        <td class="header container" align="center">
          <div class="content" style="text-align: center;">
            <span class="brand">
              <a href="https://thegopshop.com?{{$tracking2}}">
                <img src="https://cdn.shopify.com/s/files/1/0251/0189/3680/files/GOP_SHOP-03_9f334f65-6aed-4302-8110-295e6a8bcb66.png" alt="The GOP Shop" />
              </a>
            </span>
          </div>
        </td>
                  ...
                  <table class="body">
                    <tr>
                      ...
                      <td>
                        ...
                        <div><a href="#"
                        style="background-color:#f30020;border:1px solid #407429;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:17px;font-weight:bold;line-height:38px;text-align:center;text-decoration:none;width:210px;-webkit-text-size-adjust:none;">Get new item!</a></div>
      ...
      <tr>
        <td>
          <div class="content footer-lead">
            <a href="https://thegopshop.com?{{$tracking2}}"><b>Get in touch</b></a> if you have any questions or feedback
          </div>
        </td>
      </tr>
    </table>
    <table class="footer-wrap w320 full-width-gmail-android" bgcolor="#e5e5e5">
      <tr>
        <td>
          <div class="content">
            <a href="https://thegopshop.com/pages/contact-us?{{$tracking2}}">Contact Us</a>&nbsp;&nbsp;|&nbsp;&nbsp;
