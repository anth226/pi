  ...
  <div align="center">
      ...
      <tr class="header-background">
        <td class="header container" align="center">
          <div class="content" style="text-align: center;">
            <span class="brand">
              <a href="https://clickmart.com?{{$tracking}}">
                <img style="max-height: 70px; padding: 5px;" src="https://cdn.shopify.com/s/files/1/1187/6528/files/CLICKMART.png" alt="ClickMart" />
              </a>
            </span>
          </div>
        </td>
                 ...
                 <table class="body">
                    <tr>
                      ...
                      <td>
                        ...
                        <div><a href="#"
                        style="background-color:#f48677;border:1px solid #407429;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:17px;font-weight:bold;line-height:38px;text-align:center;text-decoration:none;width:210px;-webkit-text-size-adjust:none;">Get new item!</a></div>
      ...
      <tr>
        <td>
          <div class="content footer-lead">
            <a href="https://clickmart.com?{{$tracking}}"><b>Get in touch</b></a> if you have any questions or feedback
          </div>
        </td>
      </tr>
    </table>
    <table class="footer-wrap w320 full-width-gmail-android" bgcolor="#e5e5e5">
      <tr>
        <td>
          <div class="content">
            <a href="https://clickmart.com?{{$tracking}}">Shop</a>&nbsp;&nbsp;|&nbsp;&nbsp;
