            ...
            if (params.international) {
                ...
                $(this).bind('paste', function (e) {
                    ...
                    if (!$.isNumeric(inputValue)) {
                        ...
                        if (inputValue.length > 9) {
                            inputValue = String(inputValue.replace(/(\d{3})(\d{3})(\d{4})/, "+1 ($1) $2-$3"));
                        } else if (inputValue.length > 6) {
                            inputValue = String(inputValue.replace(/(\d{3})(\d{3})(?=\d)/g, '+1 ($1) $2-'));
                        } else if (inputValue.length > 3) {
                            inputValue = String(inputValue.replace(/(\d{3})(?=\d)/g, '+1 ($1) '));
                        }
